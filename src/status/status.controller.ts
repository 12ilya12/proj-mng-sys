...
export class StatusController {
    ...
    @ApiParam( {name: 'id', required: true, description: 'Идентификатор статуса', type: Number} )
    @ApiOkResponse({ description: "Успех", type: StatusDto })
    @ApiNotFoundResponse({ description: "Не найдена статус с заданным идентификатором" })
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
    ...
    @ApiCreatedResponse({ description: "Статус успешно создан", type: StatusDto })
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
    ...
    @ApiOkResponse({ description: "Успех", type: StatusDto })
    @ApiNotFoundResponse({ description: "Не найден статус с заданным идентификатором" })
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
    @SetMetadata('roles', ['ADMIN'])
    ...
    @ApiOkResponse({ description: "Успех" })
    @ApiNotFoundResponse({ description: "Не найден статус с заданным идентификатором" })
    @ApiConflictResponse( {description: "У данного статуса есть связанные задачи"} )
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
    @SetMetadata('roles', ['ADMIN'])
