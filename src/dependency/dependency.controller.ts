...
import { ApiBadRequestResponse, ApiBody, ApiCreatedResponse, ApiForbiddenResponse, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiParam, ApiQuery, ApiTags } from "@nestjs/swagger";
...
export class DependencyController {
    ...
    @ApiParam( {name: 'taskId', required: true, description: 'Идентификатор родительской задачи', type: Number} )
    ...
    @ApiQuery( {name: 'orderBy', required: false, description: 'Критерий сортировки ("id", "parentTaskId", "childTaskId")', type: String} )
    ...
    @ApiCreatedResponse({ description: "Зависимость успешно создана", type: DependencyDto })
    @ApiForbiddenResponse( {description: "Пользователь может создавать зависимости только между своими задачами"} )
    @ApiNotFoundResponse( {description: "Не найдена задача с заданным идентификатором"} )
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
    ...
    @ApiParam( {name: 'id', required: true, description: 'Идентификатор зависимости', type: Number} )
    @ApiOkResponse({ description: "Успех" })
    @ApiNotFoundResponse({ description: "Не найдена зависимость с заданным идентификатором" })
    @ApiBadRequestResponse({ description: "Некорректный запрос" })
